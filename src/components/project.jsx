            ...
            <div className="bg-white">
                <div className="pt-6">
                    ...
                    <div className="mx-auto max-w-2xl pt-5 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto_auto_1fr] lg:gap-x-8 lg:px-8 lg:pt-16 lg:pb-24">
                        ...
                        <div dangerouslySetInnerHTML={{ __html: project.body }} className="py-2 lg:col-span-2 lg:col-start-1 lg:border-r lg:border-gray-200 lg:pt-6 lg:pr-8 lg:pb-16"></div>
                    </div>
                </div>
            </div>
        </>
