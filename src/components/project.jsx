                                    ...
                                    <ul className="space-y-4">
                                        {comments && currentItems.length > 0 ? currentItems.map((comment, index) => (
                                            <li key={index} className="p-3 bg-gray-100 rounded-lg">
                                                ...
                                                <span className="text-sm text-gray-500">{formatDistance(dateFnsTz.utcToZonedTime(new Date(comment.date_created), 'Europe/Stockholm'), new Date(), { locale: sv })} sedan</span>
                                            </li>
                                        )) : (
